...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <a class="btn btn-primary" href="index.php?c=departments&m=add"> Add Department</a>
        <div class="row mt-3">
        ...
        <table class="table table-bordered table-striped my-3">
            ...
            <?php foreach($departments as $key => $item): ?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary btn-sm" href="index.php?c=departments&m=edit&id=<?=$item['id']; ?>"> Edit</a>
                    </td>
                    <td>
                        <a class="btn btn-danger btn-sm" href="index.php?c=departments&m=delete&id=<?=$item['id'];?>">Delete</a>
                    </td>
                </tr> 
            <?php endforeach; ?>
...
<script>
    ...
    btnSearch.addEventListener('click', function() {
        ...
        if(keyword != '') {
            window.location.href = "index.php?c=departments&search="+keyword;
        } else {
