...
$titlePage = "Page - Update Departments";
$errorAdd = $_SESSION['error_update_department'] ?? null; 
?>
...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <a class="btn btn-primary" href="index.php?c=departments&m=add">List Department</a>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="leader" value="<?= $info['leader']; ?>">
